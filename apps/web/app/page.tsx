          ...
          <div className="text-center">
            ...
            <div className="mt-16 flex flex-col items-center gap-4">
              ...
              <p className="text-xs text-neutral-500 dark:text-neutral-400">
                {state.message ? (
                  <span className={state.status === "success" ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"}>
                    {state.message}
                  </span>
                ) : (
      ...
      <footer className="py-6">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://github.com/moinulmoin/openscriber"
              target="_blank"
            ...
            <a
              href="https://x.com/useopenscriber"
              target="_blank"
              rel="noopener noreferrer"
              className="text-neutral-500 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-100 transition-colors"
          ...
          <p className="text-center text-sm text-neutral-500 dark:text-neutral-400">
            Built by <a href="https://moinulmoin.com" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-100 transition-colors">Moinul Moin</a>
          </p>
        </div>
      </footer>
    </div>
